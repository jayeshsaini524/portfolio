    ...
    <section id="tech" className="relative py-12 sm:py-16 overflow-hidden">
      <div className="max-w-7xl mx-auto px-8 lg:px-16">
        <AnimatedSection>
          ...
          <p className="text-dark-400 max-w-2xl mb-12 text-lg sm:text-xl leading-relaxed">
        ...
        <div className="grid sm:grid-cols-2 gap-6 lg:gap-8">
          {categories.map((cat, ci) => (
            <AnimatedSection key={cat.title} delay={ci * 0.08} variant="scale">
              <div className="glass-card rounded-3xl p-5 h-full relative overflow-hidden group transition-all duration-500 hover:shadow-2xl hover:shadow-accent-500/5">
                <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative z-10">
                  <h3 className="text-xs font-bold text-dark-400 uppercase tracking-widest mb-4 pb-2 border-b border-white/5">
                    {cat.title}
                  </h3>
